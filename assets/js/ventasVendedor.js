...
// })
 ...
 $('.tablaProductoVendedor').DataTable( {
    "ajax": "../ajax/productosVentas.php",
    "deferRender": true,
	"retrieve": true,
	"processing": true,
	 "language": {
...
$(".tablaProductoVendedor tbody").on("click", "button.agregarProducto", function(){
	...
	$.ajax({
		...
		url: "../ajax/ajaxProductosventas.php",
		method: "POST",
		data: datos,
		cache: false,
		contentType: false,
		...
		success: function (respuesta) {
			...
			$(".nuevoProductoVendedor").append(
					'<tr>'+
							...
							'<td class="precio"><input type="number" class="costoProducto" name="costoProducto" value="'+precio+'" readonly/></td>'+
							'<td class="nuevototalp"><input type="text" class="nuevototalT"  name="nuevototalT"  value="'+precio+'" readonly></td>'+
...
function QuitarAgregarProducto(){
	...
	var botonesTabla = $(".tablaProductoVendedor tbody button.agregarProducto");
...
$(".tablaProductoVendedor").on("draw.dt", function(){
 //console.log("tabla");
...
$(".formularioVentasVendedor").on("click", "button.quitarProducto", function(){
...
$(".formularioVentasVendedor").on("change", "input.CantidadProd", function(){
...
=============================================*/
function sumarTotalPreciosVendedor(){
	...
	i
		$("#nuevoTotalVendedor").val(sumaTotalPrecio);
		$("#totalVendedor").val(sumaTotalPrecio);
