...
// })
 ...
 $('.tablaProductoTrasladoInsumo').DataTable( {
    "ajax": "../ajax/productosInsumo.php",
    "deferRender": true,
	"retrieve": true,
	"processing": true,
	 "language": {
...
$(".tablaProductoTrasladoInsumo tbody").on("click", "button.agregarProducto", function(){
	...
	$.ajax({
		...
		success: function (respuesta) {
			...
			sumarTotalPreciosTrasladoInsumos()			
			
			
			listarProductosTrasladoInsumos()
...
function QuitarAgregarProducto(){
	...
	var botonesTabla = $(".tablaProductoTrasladoInsumo tbody button.agregarProducto");
...
$(".tablaProductoTrasladoInsumo").on("draw.dt", function(){
 //console.log("tabla");
...
=============================================*/
function sumarTotalPreciosTrasladoInsumos(){
...
function listarProductosTrasladoInsumos(){
	var listaProductos = [];
