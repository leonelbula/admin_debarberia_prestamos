 $('.tablaInsumosComponentes').DataTable( {
    "ajax": "../ajax/componentesInsumos.php",
    "deferRender": true,
	"retrieve": true,
	"processing": true,
	 "language": {
...
$(".tablaInsumosComponentes tbody").on("click", "button.agregarProducto", function(){
...
function QuitarAgregarProducto(){
	...
	var botonesTabla = $(".tablaInsumosComponentes tbody button.agregarProducto");
...
$(".tablaInsumosComponentes").on("draw.dt", function(){
 //console.log("tabla");
