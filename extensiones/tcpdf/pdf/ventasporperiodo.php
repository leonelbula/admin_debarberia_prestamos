...
$sql = "SELECT * FROM venta_vendedores WHERE fecha LIKE '%$fechaFinal%'";
...
$sql = "SELECT * FROM venta_vendedores WHERE fecha BETWEEN '$fechaInicial' AND '$fechaFinalMasUno'";
} else {
$sql = "SELECT * FROM venta_vendedores WHERE fecha BETWEEN '$fechaInicial' AND '$fechaFinal'";
}
}
...
$datosReporte = $reporte->MostrarVendedorId($value['id_vendedor']);
