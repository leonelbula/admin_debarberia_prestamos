...
$sql = "SELECT ve.nombre,ve.nit, v.*, SUM(v.totalventa) AS venta FROM venta_vendedores v INNER JOIN vendedores ve ON v.id_vendedor=ve.id AND fecha LIKE '%$fechaFinal%' GROUP BY v.id_vendedor";
...
$sql = "SELECT ve.nombre,ve.nit, v.*, SUM(v.totalventa) AS venta FROM venta_vendedores v INNER JOIN vendedores ve ON v.id_vendedor=ve.id AND fecha BETWEEN  '$fechaInicial' AND '$fechaFinalMasUno' GROUP BY v.id_vendedor";
} else {
$sql = "SELECT ve.nombre,ve.nit, v.*, SUM(v.totalventa) AS venta FROM venta_vendedores v INNER JOIN vendedores ve ON v.id_vendedor=ve.id AND fecha BETWEEN  '$fechaInicial' AND '$fechaFinal' GROUP BY v.id_vendedor";
}
}
