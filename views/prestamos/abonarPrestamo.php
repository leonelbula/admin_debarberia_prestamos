	...
	<section class="content">
		...
		<div class="box">
			...
			<div class="box-header with-border">
				<a href="<?= URL_BASE ?>prestamos/verprestamo&id=<?= $_GET['id'] ?>">
			...
			<div class="box-body">
				...
				<div class="row">
					<form action="<?= URL_BASE ?>prestamos/guardarabono" method="POST" >
						<?php
						foreach ($detalles as $key => $value):
							...
							<div class="col-md-8">
								...
								<input type="hidden" name="idCliente" value="<?= $value['id_cliente'] ?>"/> 		
