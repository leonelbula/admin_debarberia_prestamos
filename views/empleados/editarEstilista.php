		...
		<div class="box">
			...
			<div class="box-body">
				...
				<div class="col-xs-6">
					...
					<form method="post" action="<?= URL_BASE ?>empleados/actulizarbarbero" enctype="multipart/form-data">
							...
							<div class="box-body">
								<div class="form-group">
									...
									<div class="input-group">
										...
										<?php 
										while ($row1 = $detallesEtilista->fetch_object()) :
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="date" class="form-control input-lg " value="<?=$row1->fecha_registro?>" name="fechaingreso" required> 
