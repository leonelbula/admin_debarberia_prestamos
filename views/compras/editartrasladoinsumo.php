			...
			<div class="col-md-12">
				<div class="box">
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" class="formularioTraslado" id="formulario" method="POST" action="actulizartrasladoinsumo">
							<?php 
							...
							<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
								<a data-toggle="modal" href="#myModalInsumo">           
...
<!--Fin-Contenido-->
<div class="modal" id="myModalInsumo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
    <div class="modal-dialog" >
		<div class="modal-content">
			...
			<div class="modal-body">
				<table  class="table table-bordered table-striped dt-responsive tablaProductoTrasladoInsumo">
					<thead>
					<th>#</th>
					<th>Codigo</th>
					<th>Nombre</th>					
