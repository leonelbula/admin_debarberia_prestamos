			...
			<div class="col-xs-6">
				<form method="post" action="<?=URL_BASE?>categoria/actulizar" enctype="multipart/form-data">
					<?php 
						...
						$datos = productosController::MostarCategoria($id);
		   ...
		   <tbody>
			   <?php 
                ...
                <tr>
                  ...
                  <td>
					  <div class="btn-group">
						  <a href="<?=URL_BASE?>productos/categoria/index&id=<?=$row->id?>">
							  <button class="btn btn-warning btnEditarCategoria">
								  <i class="fa fa-pencil"></i>
							  </button>
						  </a>
						  <a href="<?=URL_BASE?>productos/categoria/eliminar&id=<?=$row->id?>">
...
<div id="modalAgregarCategoria" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
		...
		<form method="post" action="<?=URL_BASE?>productos/registrarcategoria" enctype="multipart/form-data">
