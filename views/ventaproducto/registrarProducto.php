	...
	<section class="content">
		...
		<div class="box">
			...
			<div class="box-header with-border">
				<a href="<?= URL_BASE ?>ventasproducto/productos">
			...
			<div class="box-body">
				<div class="col-md-8">
					<form class="formularioProducto" action="<?= URL_BASE ?>ventasproducto/guardarproducto" enctype="multipart/form-data" method="POST">
						<div class="row">
							<div class="col-xs-6">
