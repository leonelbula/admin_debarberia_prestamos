    ...
    <section class="content">
		...
		<div class="box">
			<div class="box-header with-border">
				<h3 class="box-title">Cobro de  Venta</h3>

			</div>
			<div class="box-body">
				<div class="row">
					<div class="col-xs-6">
						<form method="post" class="formularioCobroServicio" action="<?= URL_BASE ?>sucursal/pagarventa" enctype="multipart/form-data">

						<?php 
						
							$id = $_GET['id'];
							$detalles = sucursalController::verventaproducto($id);
							
							while ($row = $detalles->fetch_object()) {
								$valor = $row->totalventa;
							}
