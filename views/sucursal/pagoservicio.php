    ...
    <section class="content">
		...
		<div class="box">
			<div class="box-header with-border">
				<h3 class="box-title">Cobro de  Servico</h3>

			</div>
			<div class="box-body">
				<div class="row">
					<div class="col-xs-6">
						<form method="post" class="formularioCobroServicio" action="<?= URL_BASE ?>sucursal/pagarservicio" enctype="multipart/form-data">

						<?php 
						
							$id = $_GET['id'];
							$detalles = sucursalController::verventaservicio($id);
							...
							<div class="modal-header" style="background:#3c8dbc; color:white">								
								...
								<h4 class="modal-title">COBRAR SERVICIO</h4>
